...
tags:
  ...
  - c++
date: 2023-01-16
excerpt: Using a strategy pattern, Let's see how to implement C++ program that parses an XML file's service information and creates classes based on the service information.
