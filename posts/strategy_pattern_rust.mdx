...
tags:
  ...
  - rust
date: 2023-01-17
excerpt: Using a strategy pattern, Let's see how to implement Rust program that parses an XML file's service information and creates classes based on the service information.
